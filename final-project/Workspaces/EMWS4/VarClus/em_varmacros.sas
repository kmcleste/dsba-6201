...
%let EM_NUM_VARS = 93;
   ...
   DOLLARQ21 DOLLARQ22 DOLNETDA DOLNETDT FREQPRCH METHPAYM MONLAST PCPAYM RESPOND
   TENURE TOTORDQ01 TOTORDQ02 TOTORDQ03 TOTORDQ04 TOTORDQ05 TOTORDQ06 TOTORDQ07
   TOTORDQ08 TOTORDQ09 TOTORDQ10 TOTORDQ11 TOTORDQ12 TOTORDQ13 TOTORDQ14 TOTORDQ15
   TOTORDQ16 TOTORDQ17 TOTORDQ18 TOTORDQ19 TOTORDQ20 TOTORDQ21 TOTORDQ22 UNITSIDD
   UNITSLAP UNTLANPO _dataobs_
   %mend EM_VARS;
%let EM_NUM_CLASS = 5;
   %macro EM_CLASS;
...
%let EM_NUM_INTERVAL = 88;
   ...
   DOLLARQ22 DOLNETDA DOLNETDT FREQPRCH MONLAST TENURE TOTORDQ01 TOTORDQ02
   TOTORDQ03 TOTORDQ04 TOTORDQ05 TOTORDQ06 TOTORDQ07 TOTORDQ08 TOTORDQ09 TOTORDQ10
   TOTORDQ11 TOTORDQ12 TOTORDQ13 TOTORDQ14 TOTORDQ15 TOTORDQ16 TOTORDQ17 TOTORDQ18
   TOTORDQ19 TOTORDQ20 TOTORDQ21 TOTORDQ22 UNITSIDD UNITSLAP UNTLANPO _dataobs_
   %mend EM_INTERVAL;
...
%let EM_NUM_REJECTS = 6;
   %macro EM_REJECTS;
    COUNTY DTBUYLST DTBUYORG ORDERSIZE STATE ZIP
   %mend EM_REJECTS;
