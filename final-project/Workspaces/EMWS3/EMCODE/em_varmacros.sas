...
%let EM_NUM_VARS = 27;
   %macro EM_VARS;
    DemAge DemCluster DemGender DemHomeOwner DemMedHomeValue DemMedIncome
   DemPctVeterans GiftAvg36 GiftAvgAll GiftAvgCard36 GiftAvgLast GiftCnt36
   GiftCntAll GiftCntCard36 GiftCntCardAll GiftTimeFirst GiftTimeLast ID PromCnt12
   PromCnt36 PromCntAll PromCntCard12 PromCntCard36 PromCntCardAll StatusCat96NK
   StatusCatStarAll TargetB
   %mend EM_VARS;
%let EM_NUM_CLASS = 7;
   %macro EM_CLASS;
    DemCluster DemGender DemHomeOwner ID StatusCat96NK StatusCatStarAll TargetB
   %mend EM_CLASS;
%let EM_NUM_INTERVAL = 20;
   ...
   GiftTimeFirst GiftTimeLast PromCnt12 PromCnt36 PromCntAll PromCntCard12
   PromCntCard36 PromCntCardAll
   %mend EM_INTERVAL;
...
%let EM_NUM_INPUT = 25;
   %macro EM_INPUT;
    DemAge DemCluster DemGender DemHomeOwner DemMedHomeValue DemMedIncome
   DemPctVeterans GiftAvg36 GiftAvgAll GiftAvgCard36 GiftAvgLast GiftCnt36
   GiftCntAll GiftCntCard36 GiftCntCardAll GiftTimeFirst GiftTimeLast PromCnt12
   PromCnt36 PromCntAll PromCntCard12 PromCntCard36 PromCntCardAll StatusCat96NK
   StatusCatStarAll
   %mend EM_INPUT;
